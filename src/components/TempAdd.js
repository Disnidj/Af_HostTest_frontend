...
const TempAdd = () => {
  ...
  return (
    <div>
              ...
              <a href="/TempNavbar" style={{textDecoration:'none',backgroundColor:'#3895d3',color:'white',fontSize:'20px'}}> 
              <i class="far fa-arrow-alt-circle-left"></i>&nbsp;Go Back</a>
              </button>

          <div style={{ Width: 500, margin: "auto" , marginTop:'70px',backgroundColor:'#4c54e4'}}>
            ...
            <form onSubmit={upload} encType="multipart/form-data" style={{ marginLeft:'400px'}} >
              ...
              <h1 style={{color:"white"}} >Upload Your Template Document HERE <i class="fa-solid fa-cloud-arrow-up"></i> !</h1>
