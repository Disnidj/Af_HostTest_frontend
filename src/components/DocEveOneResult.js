...
export default function DocEveOneResult()  {
    ...
    return (
       ...
       <div style={{height:'80px', width:'100%', backgroundColor:"#000080", marginTop:'-20px',}}>
               <br/>
               <h2 style={{color:'white', textAlign:'center',}}> Your Document Result</h2>
              <br/>
     </div>
           <br/>
           ...
           <table className='table' style={{border:'1px solid black', width:'50%', marginLeft:'400px'}}>
             ...
             <td style={{fontSize:'20px'}}><b>Comments or Feedback</b></td>
               <td>{Comment}</td>
                ...
                <button className="btn btn-success" style={{marginLeft:'700px',padding:'10px 10px',backgroundColor:'#3895d3'}}><a href="/DocEveResult"
