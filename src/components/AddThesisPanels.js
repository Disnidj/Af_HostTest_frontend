...
export default class AddThesisPanels extends Component {
...
render(){
    return (
        ...
        <div>
         ...
         <br/>
            <center><h1> THESIS PANEL FORMATION </h1></center> 
        <br/>
            ...
            <tr>
                <th>
                    ...
                    <form>
                            ...
                            <button className="btn btn-warning"><a href = "/ViewThesis" style = {{textDecoration:'none',color:'white',marginTop:'15px'}}>View Panels</a></button>
