...
export default function PresEveOneResult()  {
    ...
    return (
       ...
       <div style={{height:'80px', width:'100%', backgroundColor:"#000080", marginTop:'-20px',}}>
               <br/>
               <h2 style={{color:'white', textAlign:'center',}}>Your Final Marks</h2>
              <br/>
     </div>
           <br/>
           ...
           <table className='table' style={{border:'1px solid black', width:'50%', marginLeft:'400px'}}>
             ...
             <tr>
               ...
               <td><t></t><t></t>{Total}</td>
                ...
                <button className="btn btn-success" style={{marginLeft:'700px',padding:'10px 10px',backgroundColor:'#3895d3'}}><a href="/PreseEveResult"
