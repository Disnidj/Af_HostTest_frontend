...
export default class AddTopisPanels extends Component {
...
handleInputChange = (e) =>{
 ...
 onSubmit = (e) =>{
     ...
     axios.post(`https://afsliitproject.herokuapp.com/TopicPanels/save`,data).then((res)=>{
        console.log(data);
         if(res.data.success){
             this.setState(
                 {
...
render(){
    return (
        ...
        <div>
         ...
         <br/>
            <center><h1> -TOPIC PANEL FORMATION- </h1></center> 
        <br/>
            ...
            <tr>
                <th>
                    ...
                    <form>
                        ...
                        <button className="btn btn-warning"><a href = "/ViewTopis" style = {{textDecoration:'none',color:'white',marginTop:'15px'}}>View Details</a></button>
