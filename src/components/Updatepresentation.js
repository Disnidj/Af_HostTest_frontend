...
export default function UpdatePresentation()  {
    ...
    return (
        <div>
         ...
         <br/>
            <center><h1>PRESENTATION PANEL REGISTRATION UPDATE</h1></center> 
          <br/>
            ...
            <tr>
                <th>
                    <form>
                        ...
                        <button className="btn btn-warning"><a  href = "/ViewPresentation" style = {{textDecoration:'none',color:'white',marginTop:'15px'}} >VIEW DETAILS</a></button>
